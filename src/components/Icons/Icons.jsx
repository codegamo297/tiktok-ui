...
export const CameraIcon = ({ width, height, className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const UserArrowActiveIcon = ({
    width = "2.4rem",
    height = "2.4rem",
    className,
}) => (
...
CreativeIcon.propTypes =
    ...
    CoinTiktokIcon.propTypes =
    CameraIcon.propTypes =
    CameraActiveIcon.propTypes =
    SettingIcon.propTypes =
    LogoutIcon.propTypes =
    HomeIcon.propTypes =
    HomeActiveIcon.propTypes =
    UserArrowIcon.propTypes =
    UserArrowActiveIcon.propTypes =
    UsersIcon.propTypes =
    UsersActiveIcon.propTypes =
    CompassIcon.propTypes =
    CompassActiveIcon.propTypes =
